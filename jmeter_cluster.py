...
DEFAULT_IMAGE = 'projects/ubuntu-os-cloud/global/images/ubuntu-1604-xenial-v20190514'
  ...
  def _WaitForAllInstancesSshReady(self):
    ...
    while True:
      ...
      for index in xrange(size):
        ...
        command = ('gcloud compute --project "%s" ssh --zone "%s" '
                   '"%s" --command="exit"') % (self.project, DEFAULT_ZONE, instance_name)
